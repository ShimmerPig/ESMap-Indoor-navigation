window.app = {
	 ...
	 * 后端服务发布的url地址
	 */
	serverUrl: 'http://shimmerpig.natapp1.cc',
	//http://shimmerpig.natapp1.cc
	/**
	 * 图片服务器的url地址
	 */
	...
	setCoord: function(coord){
		var coordStr=JSON.stringify(coord);
		plus.storage.setItem("coord", coordStr);
	},
	getCoord: function(){
		var coordStr = plus.storage.getItem("coord");
		
		if (!this.isNotNull(coordStr)) {
			return [];
		}
